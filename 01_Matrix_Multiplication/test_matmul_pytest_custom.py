...
class TestMatrixMultiplication:
    ...
    def test_sample(self):
        """Test larger matrix multiplication with identity"""
        matrix1 = [[1, 45, 3, 5, -8], [-2.345, 7, 0, 65, 5.9], [3, 6.8, 4, 2, 4], [5, 4, 6, 6, 5]]
        matrix2 = [[1, 0.02, 2.89], [-7, -17, 89], [2, 4, 3], [23, 6, 8.9], [45, 3, 3]]
        expected = [[-553, -746.98, 4037.39], [1709.155, 288.6531, 1212.42295], [189.4, -75.54, 655.67], [352, 7.1, 456.85]]
        result = matrix_multiply(matrix1, matrix2)
        for i in range(4):
            for j in range(3):
                print(result[i][j] - expected[i][j], end = '  ')
            print('\n')
        assert result == expected
